...
namespace IICT_Store.Services.TimeSlotServices
{
    ...
    {
        Task<ServiceResponse<GetTimeSlotDto>>CreaateTimeSlot(CreateTimeSlotDto createTimeSlotDto);
         Task<ServiceResponse<List<GetTimeSlotDto>>> GetAll();
         Task<ServiceResponse<GetTimeSlotDto>> Delete(long id);
         Task<ServiceResponse<GetTimeSlotDto>> Update(CreateTimeSlotDto createTimeSlotDto,long id);
